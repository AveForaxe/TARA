...
export const Kegiatan: React.FC = () => {
  ...
  const handleRegisterSuccess = () => {
    setShowModal(false);
    showNotification('success', 'Pendaftaran Berhasil', 'Pendaftaran berhasil! Kartu digital QR Anda akan dikirim via WhatsApp.');
  };
          ...
          <Reveal className="glass-card" style={{ maxWidth: '480px', width: '100%', position: 'relative', padding: '40px', border: '1px solid rgba(255, 77, 141, 0.2)' }}>
            ...
            <div className="form-group">
              ...
              <div className="input-icon-wrapper">
                <input type="text" className="form-input" placeholder="Masukkan nama lengkap" />
            ...
            <div className="form-group">
              ...
              <div className="input-icon-wrapper">
                <input type="text" className="form-input" placeholder="Contoh: RT 05 / RW 02" />
                <span className="material-icons-round">location_on</span>
              </div>
            </div>

            <div style={{ margin: '24px 0' }}>
              <button className="btn btn-primary btn-premium" onClick={handleRegisterSuccess}>
                <span className="material-icons-round">how_to_reg</span> Daftar Sekarang
              </button>
            </div>
